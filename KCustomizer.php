...
class KCustomizer{
    ...
    function get_santize_callback($field){
        ...
        switch($field){
            case "text":
            case "textarea":
                return array($this, 'ostore_textbox_sanitize');
                break;
            case 'number': 
                return array($this, 'ostore_number_sanitize');
                break;
            case "radio":
                return array($this, 'ostore_radio_enable_sanitize');
                break;
    ...
    function ostore_checkbox_sanitize($input){
        if ( $input == 1 ) {
            return 1;
        } else {
            return 0;
	...
	*/
    function ostore_radio_enable_sanitize($input) {
        $valid_keys = array(
           'enable' => esc_html__('Enable', 'metrostore-pro'),
	       'disable' => esc_html__('Disable', 'metrostore-pro'),
        );
	...
	* number santization
	*/
    function ostore_number_sanitize( $int ) {
        return absint( $int );
    }
    /**
	* Text Sanitization
	*/
    function ostore_textbox_sanitize( $input ) {
